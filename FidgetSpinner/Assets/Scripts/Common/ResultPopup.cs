...
namespace Fidget.Common
{
    public class ResultPopup : MonoBehaviour
    {
        ...
        public void BottomBtnAnimation()
        {
            ...
            LeanTween.moveLocalY(btnBack, -400.0f, 0.5f).setEaseOutBounce();
            LeanTween.moveLocalY(btnRank, -400.0f, 0.5f).setEaseOutBounce().setDelay(0.3f);
            LeanTween.moveLocalY(btnShare, -400.0f, 0.5f).setEaseOutBounce().setDelay(0.6f);
        }
